...
// 	const { fetchEvents, updateEvent, publishResults, deleteEvent } = useEventStore();
...
// 	const handleOpenModal = (event, status) => {
...
// 		try {
// 			await updateEvent(selectedEvent._id, { status: newStatus });
// 			setEventsByStatus((prev) => {
// 				const updated = { ...prev };
// 				updated[selectedEvent.status] = updated[selectedEvent.status].filter((e) => e._id !== selectedEvent._id);
// 				updated[newStatus] = [...updated[newStatus], { ...selectedEvent, status: newStatus }];
// 				return updated;
// 			});
// 			handleCloseModal();
// 		} catch (error) {
...
// 													color="success"
// 													size="small"
// 													onClick={() => handleOpenModal(event, "open")}
// 												>
// 													Approve
// 												</Button>
...
// 													color="secondary"
// 													size="small"
// 													onClick={() => handleOpenModal(event, "ongoing")}
// 												>
// 													Start Event
// 												</Button>
// 												{hasCriteria && (
...
// 												color="success"
// 												size="small"
// 												onClick={() => handleOpenModal(event, "completed")}
// 											>
// 												Complete Event
// 											</Button>
// 										)}
// 										{status === "completed" && hasCriteria && (
// 											<Box display="flex" gap={1} flexWrap="wrap">
// 												<Button
// 													variant="contained"
// 													color="primary"
...
// 							<h2>
// 								<strong>The event will be automatically updated anyway...</strong>
// 							</h2>
// 						)}
// 						Are you sure you want to set <strong>{selectedEvent?.name}</strong> to <strong>{newStatus}</strong>?
// 					</DialogContentText>
// 				</DialogContent>
// 				<DialogActions>
